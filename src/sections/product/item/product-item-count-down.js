...
export default function ProductItemCountDown({ product, color = 'primary', sx }) {
  const theme = useTheme();

  return (
    <Link component={RouterLink} href={paths.product} color="inherit" underline="none">
      <Stack
        spacing={3}
        sx={{
          p: 3,
...
ProductItemCountDown.propTypes = {
